...
> 채널: [@kr_dailyquant](https://t.me/kr_dailyquant) | 전략 버전: v70 | 최종 업데이트: 2026-03-24
...
| 팩터 | 비중 | 서브팩터 | 정규화 |
|------|------|----------|--------|
| **Value** | 20% | PER + PBR + PCR + PSR | 전체 유니버스 rank z-score (낮을수록 좋음) |
| **Quality** | 20% | ROE + GPA + CFO | 전체 유니버스 rank z-score |
| **Growth** | 30% | 매출성장률×0.7 + 영업이익변화율×0.3 | 전체 유니버스 rank z-score (커버리지 96%) |
