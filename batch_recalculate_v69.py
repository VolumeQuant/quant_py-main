...
v68→v69 변경:
- version 6.8 → 6.0
- strategy_b_multifactor.py가 v69 코드이므로 PER>200 필터, Blom rank z-score,
  4팩터 동일가중(V25+Q25+G25+M25), 섹터중립 M만, floor -1.5σ 등 자동 적용
...
def main():
    ...
    print("=" * 70)
    print(f"v69 고속 재계산 — {len(dates)}일 ({dates[0]} ~ {dates[-1]})")
    print("=" * 70)
