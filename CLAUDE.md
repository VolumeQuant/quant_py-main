...
### 국면전환 성과 (2021-01 ~ 2026-04, 1290일)
- **Calmar=6.62, CAGR=186.2%, MDD=28.1%**
- **Sharpe=2.51, Sortino=4.07**
...
- 궤적 표시: 각 날짜의 wr 정렬 후 정수 순위 (cr 아님). rank z-score 불안정 대응 (CSWZ 검토→부적합, 표시만 변경).
