...
# 🇰🇷 KR 전략 — quant_py-main (v77 유지, 2026-04-14)

> 경로: `C:\dev\claude code\quant_py-main`

## 국면전환 전략 (v77 유지, 2026-04-14)

### v77→v78→v77 복원 경위 (2026-04-13~14)
- 2026-04-13 저녁: v78(7.8년 BT Cal=3.40) 프로덕션 적용 직후 5년 프로덕션에서 v77 대비 **수익률 80% 하락** 확인
- 2026-04-13 밤: v77 복원 + ranking 2586개 재계산 (커밋 9e4a2cc98)
- 2026-04-14: 2018 whipsaw 보완안 탐색 결과 → **v77 기본 유지 결정** (상세: `WHIPSAW_ANALYSIS_2026_04_14.md`)

### 국면 규칙 (KP_MA200_5d)
- **KOSPI > 200일 이동평균** = 공격, 미만 = 방어
- **5일 연속 확인** 후 전환 (버퍼/쿨다운 추가 시 성과 악화 확인)
- 전환 시 기존 포트폴리오 **전량 청산** → 새 전략 재진입
- 전환 빈도: 7.8년 BT 21회 (연 ~3회)
...
### 성과
- **5.25년 BT (2021-01~2026-04): Cal=4.41, CAGR=127.9%, MDD=29.0%**
- **7.8년 BT (2018-07~2026-04): Cal=1.37, CAGR=79.6%, MDD=57.9%**
  - 7.8년 Cal이 낮은 이유: 2019-2020 긴 하락장 + 2018 whipsaw 구간 일부
  - 2018 whipsaw 4회 구간(2018-02~06)은 BT 범위 밖
- 2026-04-14 버퍼/쿨다운/확인일수 테스트 결과 모두 악화 or 소폭 개선 → v77 유지
