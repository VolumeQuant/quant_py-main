...
### 국면 규칙
- **KP120_3d + VIX25**: KOSPI > MA120 AND VIX < 25 = 공격, 아니면 방어
- **3일 확인** (연속 3일 조건 충족 시 전환)
- 전환 시 기존 포트폴리오 청산 → 새 전략 재진입

### 방어 모드 (Defense) — KOSPI < MA120 or VIX ≥ 25
- **V20 + Q10 + G20 + M50**
- G 내부: g_rev=0.6 (매출 60% + 영업이익변화 40%)
- 모멘텀: 6M-1M (최근 1개월 제외)
- 진입: rank ≤ 5, 퇴출: WR > 8, 슬롯 7
- 손절: -10%, 트레일링: -15%, 상관관계: 0.6

### 공격 모드 (Boost) — KOSPI > MA120 AND VIX < 25
- **V25 + Q0 + G50 + M25**
- G 내부: g_rev=0.3 (매출 30% + 영업이익변화 70%)
- 모멘텀: 12M-1M (최근 1개월 제외)
- 진입: rank ≤ 3, 퇴출: WR > 4, 슬롯 7
- 트레일링: -20% (손절 없음)

### 국면전환 성과 (2021-01 ~ 2026-04, 1287일)
- **Calmar=6.16, CAGR=164.5%, MDD=26.7%**
- Sharpe=2.42, Sortino=3.89
- 국면 비율: Boost 55.8%, 방어 44.2%
