...
# 🇰🇷 KR 전략 — quant_py-main (v78, 2026-04-13)

> 경로: `C:\dev\claude code\quant_py-main`

## 국면전환 전략 (v78 확정, 2026-04-13)

### v77→v78 변경 배경
- v77(5.25년 BT): Cal=6.62 → **7.8년 확장 시 Cal=1.09 (과적합 확정)**
- 원인: KOSPI 데이터 부족(2020-06~)으로 2018-2020 전부 공격모드 잘못 배정
- v78: 7.8년(2018-07~2026-04) 기반 재탐색, 134개 국면 지표 + Breadth/KOSDAQ 비교
...
### G팩터 서브팩터 (v78)
- 공격: 3팩터 rev_z 50% + oca_z 30% + op_margin_z 20%
- 방어: 2팩터 rev_z 70% + oca_z 30%

### 공격 모드 (Boost) — KOSPI > MA200
- **V20 + Q0 + G45 + M35**
- G 내부: 3팩터 rev 50% + oca 30% + op_margin 20%
- 모멘텀: 12M
- 진입: rank ≤ 10, 퇴출: WR > 11, 슬롯 5
- 손절: -10%, 트레일링: -15%

### 방어 모드 (Defense) — KOSPI < MA200
- **V30 + Q15 + G25 + M30**
- G 내부: 2팩터 rev 70% + oca 30%
- 모멘텀: 6M
- 진입: rank ≤ 3, 퇴출: WR > 4, 슬롯 5
- 손절: -10%, 트레일링: -15%

### 국면전환 성과 (7.8년, 2018-07~2026-04)
- **Cal=3.40, CAGR=137.4%, MDD=40.4%**
- 공격 안정성: 100% (25개 이웃 전부 Cal≥2.0)
- WF 4기간: 4.88→3.83→3.26→3.92 (전 구간 Cal>3.0)
- bt와 state 동일 DART 기반 (point-in-time rcept_dt 필터링)
- v78 파라미터 동결 — 시장 구조 변화 시에만 재검토
...
### 그리드서치 방법론 (v78, 7.8년 BT)
- Phase 2a: Attack 3,048개 + Defense 1,566개 (V×Q×G×Mom×G서브)
- Phase 2b: Top15 × 60 E/X/S 규칙 = 1,800개
- Phase 3: 134개 국면 지표(MA/RSI/MOM/VOL/DD/GC/SLOPE) + 61개 보충(Breadth 3종/KOSDAQ/듀얼) × Top5 쌍
- Phase 4: 인접 안정성 25개 이웃 × 15개 후보
- Phase 5: Walk-Forward 4기간 × 15개 후보
- 종합 평가: Cal×0.3 + WF_min×0.3 + 안정성비율×0.2 + 전환빈도×0.2
