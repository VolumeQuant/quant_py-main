...
# 🇰🇷 KR 전략 — quant_py-main (v77, 2026-04-08)

> 경로: `C:\dev\claude code\quant_py-main`

## 국면전환 전략 (v77 확정, 2026-04-08)
...
### G팩터 서브팩터 (v77: 3팩터 지원)
- 공격: 3팩터 rev_z 50% + oca_z 30% + gp_growth_z 20%
- 방어: 2팩터 rev_accel_z 50% + op_margin_z 50%

### 공격 모드 (Boost) — KOSPI > MA200
- **V5 + Q0 + G65 + M30**
- G 내부: 3팩터 rev 50% + oca 30% + gp_growth 20%
- 모멘텀: 12M-1M
...
- **V30 + Q5 + G10 + M55**
- G 내부: 2팩터 rev_accel 50% + op_margin 50%
- 모멘텀: 6M-1M
- 진입: rank ≤ 3, 퇴출: WR > 6, 슬롯 7
- 손절: -10%, 트레일링: -15%

### 국면전환 성과 (2021-01 ~ 2026-04, 1289일)
- **Calmar=6.50, CAGR=182.5%, MDD=28.1%**
- **Sharpe=2.49, Sortino=4.02**
- 공격 안정성: 100% (이웃 17개 전부 Cal≥3.0)
- 방어 안정성: 75% (이웃 16개 중 12개 Cal≥3.0)
- WF: min=5.59 (전 기간 test Cal>5.0)
...
- composite_rank(cr): 당일 단독 순위. **판단 기준으로 절대 안 씀.** wr 계산 입력값 + 궤적 표시(r2→r1→r0)용.
...
## 스케줄러
- 일일 파이프라인: 평일(월~금) 16:00 (장 마감 후, 휴장일 자동 스킵) — 현재 비활성, 검증 후 활성화
- 종목명 캐시: 매주 일요일 10:00
