...
- **점수 공식**: `score_100 = min_wr / wr × 100` (Signal / Watchlist 공통)
  - 1위=100, 나머지는 1위 대비 **실제 격차** 반영
  - 예: 1위 wr=1.0 → 100점, 2위 wr=1.2 → 83점, 3위 wr=3.0 → 33점
  - "2위와 3위가 50점 차이 = 1위 독주" 한눈에 파악
  - "2위 83 vs 3위 81 = 곧 역전 가능" 고객 판단 용이
- 이전 공식 폐기:
