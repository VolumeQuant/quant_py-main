...
def create_regime_switch_message(regime_mode):
    ...
    if regime_mode == 'boost':
        return '\n'.join([
            ...
            '방어 → 공격 모드로 전환합니다.',
            '',
            '시총 1000억 이상 종목 중 120일선 위 비율이 40%를 넘어 3거래일 연속 확인되었습니다.',
            '',
            '━━━━━━━━━━━━━━━',
            '<b>조치 사항</b>',
            '━━━━━━━━━━━━━━━',
            '',
            '<b>1. 방어 모드 보유 종목 전량 매도</b>',
            '<b>2. 아래 브리핑의 ✅ 종목 매수</b>',
            '',
            '모드 전환 시 포트폴리오를 완전히 교체합니다.',
            '',
            '━━━━━━━━━━━━━━━',
            '<b>공격 모드 전략</b>',
            '━━━━━━━━━━━━━━━',
            '',
            '성장주 집중, 최대 3종목 보유',
            ' · Growth 70% + Value 10% + Momentum 20%',
            '',
            '<b>매수</b> · 3일 연속 상위 유지 (✅) · 상위 5위 내, 최대 3종목',
            '<b>매도</b> · 가중순위 8위 밖 이탈 · 손절 -10% · 트레일링 -15%',
            '',
            '━━━━━━━━━━━━━━━',
            '<b>백테스트 성과</b> (2021~2026, 5.25년)',
            '━━━━━━━━━━━━━━━',
            '',
            ' · CAGR +157% · MDD -29% · Calmar 5.4',
            ' · Sharpe 2.32 · Sortino 3.53',
            ' · 코스피 대비 초과수익 연 +144%p',
        ...
        return '\n'.join([
            ...
            '공격 → 방어 모드로 전환합니다.',
            '',
            '시총 1000억 이상 종목 중 120일선 위 비율이 40% 아래로 3거래일 연속 확인되었습니다.',
            '',
            '━━━━━━━━━━━━━━━',
            '<b>조치 사항</b>',
            '━━━━━━━━━━━━━━━',
            '',
            '<b>1. 공격 모드 보유 종목 전량 매도</b>',
            '<b>2. 아래 브리핑의 ✅ 종목 매수</b>',
            '',
            '모드 전환 시 포트폴리오를 완전히 교체합니다.',
            '',
            ...
            '',
            '팩터 분산, 최대 7종목 보유',
            ' · Momentum 50% + Value 20% + Growth 20% + Quality 10%',
            '',
            '<b>매수</b> · 3일 연속 상위 유지 (✅) · 상위 5위 내, 최대 7종목',
            '<b>매도</b> · 가중순위 8위 밖 이탈 · 손절 -10% · 트레일링 -15%',
            '',
            '━━━━━━━━━━━━━━━',
            '<b>백테스트 성과</b> (2021~2026, 5.25년)',
