...
| 기능 | 설명 | 실행 시간 |
|------|------|-----------|
| 포트폴리오 생성 | 3가지 전략으로 분기별 종목 선정 | ~50분 |
| 백테스팅 | 2015-2025 11년 전략 검증 | ~15분 |
| 일별 모니터링 | 진입 타이밍 자동 분석 | ~3분 |
...
**팩터 가중치**:
```
성장성 (40%): Forward EPS Z-Score
안전성 (25%): 부채비율 역수 + 이자보상배율
가치 (20%): Forward PER 역수
모멘텀 (15%): 60일 가격 수익률
```
...
- `portfolio_2026_01_strategy_c.csv` - Forward EPS 30종목
