...
| 2 | 현금 70%인데 5종목 추천 모순 | `adjusted_max_picks = (100 - cash_pct) // 20` 동적 조절 |
...
| B | [3/3]에 현금 비중 누락 | 🛡️ 시장 위험 반영: 투자 N% + 현금 N% 라인 추가 |
...
2. `send_telegram_auto.py` — 동적 종목 수, 가이드 확장, 이탈 차등, 현금 비중 표시
