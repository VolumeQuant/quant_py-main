...
Layer 1 (미국 HY): FRED BAMLH0A0HYM2 → Verdad 4분면 → 기본 현금비중
  Q1 회복기: 0% | Q2 성장기: 20% | Q3 과열: 20~30% | Q4 침체: 30~70%
...
```
🟢 신용시장 — 성장기
HY Spread(부도위험) 2.84% · 평균(3.76%)보다 낮아서 안정적이에요.
한국 BBB-(회사채) 6.4%p · 정상 범위에요.
📊 투자 80% + 현금 20% · 종목당 16%
→ 평소대로 투자하세요.
```
...
2. `send_telegram_auto.py` — 신용시장 섹션 삽입 + 동적 비중 반영
