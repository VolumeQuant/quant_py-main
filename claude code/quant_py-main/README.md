...
| **변동성** | CBOE VIX(FRED VIXCLS) → HY 보조 레이어, 5일 slope + 3지표 Concordance Check |
| **비중** | 종목당 20% × 최대 5종목, 현금 비중은 시장 위험 지표 기반 별도 권고 |
...
→ 평소대로 투자하세요.
```
Concordance: `🟢🟢🟢 3/3 안정 — 확실한 신호` / `🟢🟢🔴 2/3 안정 — 대체로 안정` / `🔴🔴🔴 0/3 안정 — 위험 신호`
