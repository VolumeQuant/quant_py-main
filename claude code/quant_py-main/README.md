...
Layer 1 — 미국 HY Spread (FRED BAMLH0A0HYM2, API 키 불필요)
  Verdad 4분면 모델:
    ...
    Q1 회복기 (넓+하락) → 현금 0%, 적극 매수
    Q2 성장기 (좁+하락) → 현금 20%, 정상 운영
    Q3 과열   (좁+상승) → 현금 20~30%, 주의 관찰
    Q4 침체   (넓+상승) → 현금 30~70%, 방어 모드 (체류 기간별 단계적 확대)

  해빙 신호 4종:
    💎 스프레드 급축소 (HY 4~5%에서 -20bp)
    💎 5% 하향 돌파 — 올클리어
    💎 60일 고점 대비 -300bp — 강력 매수 신호
    💎 Q4→Q1 전환 — 최고 매수 구간
...
*버전: 8.4 Slow In, Fast Out + Credit Monitor | 최종 업데이트: 2026-02-13 | Generated by Claude Code*
